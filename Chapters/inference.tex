...
This implies that the following set $\margpoly^I$ is a subset of $\margpoly^G$ (namely $\margpoly^{I} \subseteq \margpoly^{G}$)\footnote{\red{If $G$ include edges,  $\margpoly^{I} \subset \margpoly^{G}$. Since both sets share the same extreme point $\margpoly^{I}$ is a non-convex set.}}:
