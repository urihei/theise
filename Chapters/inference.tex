...
For example, the local polytope (defined in \eqref{eq:local_polytope}) is an outer bound  of the marginal-polytope, while the entropy is approximated by the Bethe-entropy. 
