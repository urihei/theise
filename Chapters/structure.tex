...
\red{
  Lower bound in this context means, that any algorithm given less samples than the bound can not insure success with high probability.
  }
%%
...
Since to ensure correct results, all the samples must be used, the time complexity is the maximum between the time and sample complexity, as in all learning algorithm. 
