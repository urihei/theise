...
The empirical success of BP has prompted researchers to better understand its theoretical properties, leading to a wide range of elegant results \cit{tatikonda2002loopy,ihler05b,wainwright2003tree}.
%\atodo{cite some}
