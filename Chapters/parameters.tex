...
The complexity of inference for a given model is governed by its tree-width, \cite{robertson1983graph,robertson1994quickly}
Learning models with bounded tree-width will guarantee efficient inference.
This, however, turns out to be a hard problem in itself \cite{srebro2001maximum}. Many algorithms tried to approximate this problem, for example \cite{karger2001learning,bach2001thin,elidan2009learning}.
%
