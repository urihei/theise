...
\gtodo{If Bach shows it, give a citation to him.}
...
\cite{bradley2012sample} also provide a comparison of the sample complexity of this method, composite likelihood, and ML.
