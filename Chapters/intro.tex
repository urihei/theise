...
Inference is only useful if one has a good model. A natural way to
...
``inferning''.\atodo{cite} The work described in this thesis makes several
...
In recent years, deep-learning models have revolutionized the field of machine learning.\atodo{cite} This is largely due to their striking accuracy on machine vision \cite{krizhevsky2012imagenet} and speech recognition \cite{mohamed2009deep, hinton2012deep} benchmarks, often beating previous state of the art by a large margin. A deep learning model is a function generated by combining certain basic operators such as linear functions, rectifying non-linearities, and pooling.
...
intractable \atodo{cite} since the function may in theory contain many
