...
In contrast to the variational free energy, the Bethe free energy is simple to calculate, since the local polytope is describe by linear number of  constrains and the Bethe entropy is easy to calculate.
...
More on Bethe-BP:
\begin{itemize}
\item Tree Re-Weighted belief propagation
\item Kikuchi \cite{yedidia2005constructing}
