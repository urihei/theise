...
The classic way of understanding Pseudo-Likelihood (PL) is to see it as a way to approximate the likelihood.
...
\be
pl(\xx;\thetav) = \prod_{i=1}^p p(x_i |\xx_{\setminus i}) = \prod_{i=1}^p p(x_i |\xx_{\nei{i}})
\ee
