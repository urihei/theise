...
In summary, the thesis studies hardness of learning and inference in several machine learning problems, with an empahsis on graphical models and deep learning. Our results demonstrate that appropriate relaxations of the learning and inference steps, coupled with assumptions on the underlying model, can result in methods that are empirically effective and enjoy theoretical guarantees.
